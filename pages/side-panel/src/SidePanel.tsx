...
const SidePanel = () => {
  ...
  return (
    <div>
      <div
        className={`flex h-screen flex-col ${isDarkMode ? 'bg-slate-900' : 'bg-gradient-to-br from-gray-50 to-amber-50/30'} overflow-hidden border ${isDarkMode ? 'border-slate-700' : 'border-gray-200'} rounded-2xl`}>
        <header className="header relative">
          <div className="header-logo">
            {showHistory ? (
              ...
              <span className={`text-xl font-bold ${isDarkMode ? 'text-gray-100' : 'text-gray-800'}`}>Browseless</span>
            )}
          </div>
          <div className="header-icons">
            <button
              ...
              className={`header-icon ${isDarkMode ? 'text-gray-400 hover:text-gray-300' : 'text-gray-500 hover:text-gray-700'} cursor-pointer`}
